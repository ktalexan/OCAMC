...
* This function implements a rather complex parcel detection algorithm. The algorithm uses multiple geodatabase operations and queries to determine: 
    ...
    Diagrammatically, the process is shown in the following graph ([download PDF file here](/documentation/AMCParcelDetectionAlgorithmFlowchart16.pdf){:target="_blank"}):
